...
local ie = {
    ...
    "Cooked Morsel", "Cooked Steak", "Fuel Canister", "Iron Body", "Leather Armor", "Log", "MedKit", "Metal Chair",
    "MedKit", "Old Car Engine", "Old Flashlight", "Old Radio", "Revolver", "Revolver Ammo", "Rifle", "Rifle Ammo",
    "Morsel", "Sheet Metal", "Steak", "Tyre", "Washing Machine", "Infernal Sack", "Old Sack", "Good Sack", "Giant Sack",
    "Chainsaw", "Old Axe", "Good Axe", "Ice Axe", "Strong Axe", "Chainsaw", "Strong Flashlight", "Ice sword", "Infernal sword"
}
...
local fuelItems = {"Log", "Chair", "Coal", "Fuel Canister", "Oil Barrel", "Cultist Corpse", "Crossbow Cultist Corpse", "Juggernaut Cultist Corpse", "Cultist King Corpse"}
local selectedFuelItems = {}
local foodItems = {"Cake", "Cooked Steak", "Cooked Morsel", "Steak", "Morsel", "Berry", "Carrot", "Corn", "Pumpkin", "Apple", "Ribs", "Cooked Ribs", "Stew"}
...
WindUI:Popup({
    Title = "LUCKY EXE Loaded! - 99 Night in the Forest",
...
Tabs.Combat:Slider({
    Title = "Aura Radius",
    Value = { Min = 100, Max = 99999999, Default = 100 },
    Callback = function(value)
        auraRadius = math.clamp(value, 100, 99999999)
    end
})
...
Tabs.More:Section({ Title = "Other Script", Icon = "gem" })
Tabs.More:Button({
    Title = "Livezala - 99 Night in the Forest",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/livezalaeveryday/99-Night-Forest/refs/heads/main/Script"))()
    end
})
Tabs.More:Button({
    Title = "Somtank - 99 Night in the Forest",
    Callback = function()
...
if Response and Response.guild then
    local DiscordInfo = Tabs.Credit:Paragraph({
